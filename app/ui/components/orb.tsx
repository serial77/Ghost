...
// Orb — exact ReactBits implementation (MIT © DavidHDev).
// Source: https://reactbits.dev/backgrounds/orb
// Adapted for Next.js App Router ("use client" directive added).
...
export default function Orb({
  ...
  useEffect(() => {
    ...
    // Ensure the canvas element itself is transparent — no browser default bleed
