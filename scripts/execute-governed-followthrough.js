...
SET metadata = COALESCE(metadata, '{}'::jsonb) || jsonb_build_object(
  'followthrough', ${sqlJson({
    ...
    worker_registry_id: followthroughRecord.worker_registry_id,
    worker_label: followthroughRecord.worker_label,
    worker_operator_identity: followthroughRecord.worker_operator_identity,
...
function recordActionEvents(approvalRow, followthroughRecord) {
  ...
  if (followthroughRecord.outcome_status === "allowed") {
    events.push({
      ...
      payload: {
        followthrough_id: followthroughRecord.followthrough_id,
        approval_queue_id: followthroughRecord.approval_queue_id,
        source_path: followthroughRecord.source_path,
        conversation_id: followthroughRecord.conversation_id,
        delegation_id: followthroughRecord.delegation_id,
        orchestration_task_id: followthroughRecord.orchestration_task_id,
        runtime_task_id: followthroughRecord.runtime_task_id,
        runtime_task_run_id: followthroughRecord.runtime_task_run_id,
        n8n_execution_id: followthroughRecord.n8n_execution_id,
        governance_environment: followthroughRecord.governance_environment,
        requested_capabilities: followthroughRecord.requested_capabilities,
        worker_registry_id: followthroughRecord.worker_registry_id,
        worker_label: followthroughRecord.worker_label,
        worker_operator_identity: followthroughRecord.worker_operator_identity,
        execution_state: followthroughRecord.execution_state,
